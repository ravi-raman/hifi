...
Metrics.prototype.addSample = function (ts, args) { 
  if (args === undefined) {
    ...
    this.sumStartTime += ts;
    //Dividing by 1000 to scale sumStartTime to the same level as duration (as in duration, we divide by 1000)
    this.sumStartTime /= 1000.0;
...
Metrics.prototype.getName = function(){
  return this.name;
}
...
Metrics.prototype.getAverageStartTime = function() {
  return this.sumStartTime / this.samples.length;
}
...
MetricsCategory.prototype.getMetricsMap = function() {
